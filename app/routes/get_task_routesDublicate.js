...
//                         "Minecraft" : [],"Общение" : [],
//                         "Прочее" : [] };
// const cat = ["Программирование","Доставка","Учёба","Рисование","Дизайн","Пение","Готвка","Minecraft","Общение","Прочее"];
// var temp = [];
// const a = (doc) =>{
//   return doc;
// }
...
module.exports = function(app, db) {
  ...
  app.get('/get_taskd', (req, res) => {
    ...
    try{
      ...
      // var cat8 = [];
      // var cat9 = [];
      db.db(bd_name).collection(cat).find({},{limit : 10}).toArray((err, docs) => {
        res.send(docs)
